...
public class AbpSolution5DomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AbpSolution5GlobalFeatureConfigurator.Configure();
        AbpSolution5ModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AbpSolution5DomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AbpSolution5Resource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AbpSolution5");

            options.DefaultResourceType = typeof(AbpSolution5Resource);
        ...
        {
            options.MapCodeNamespace("AbpSolution5", typeof(AbpSolution5Resource));
        });
    }
}
