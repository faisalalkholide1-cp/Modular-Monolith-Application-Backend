...
public class AbpSolution5EntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<AbpSolution5DbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also AbpSolution5DbContextFactory for EF Core tooling. */
