...
```bash
ng build ordering --watch
```

## Code scaffolding

Run `ng generate component component-name --project ordering` to generate a new component in the library.
...
```bash
npm install @moduls/ordering
```

2. Import the module in your application:
```typescript
import { OrderingModule } from '@moduls/ordering';
